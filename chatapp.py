...
def login():
	myConnection = psycopg2.connect( host='103.14.127.78', user='postgres', password='vinoveuser', dbname='chatdb' )
...
@app.route('/edit')
def edit():
	con=psycopg2.connect(host='103.14.127.78',port='5432',user='postgres',password='vinoveuser', database='chatdb')
	cur=con.cursor()
